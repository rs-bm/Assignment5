    ...
    private void getPkmn(String s) {
        ...
        req.getAsJSONObject(new JSONObjectRequestListener() {
            ...
            public void onResponse(JSONObject jsonObject) {
                String imageURL = "https://raw.githubusercontent.com/HybridShivam/Pokemon/master/assets/images/001.png" + "001" + ".png";
                ImageView iv = findViewById(R.id.logoView);
                Picasso.get().load(imageURL).into(iv);
                try {
                    // Populate listview on left side
                    String row = jsonObject.getInt("id") + "   " + jsonObject.getString("name");
                    ...
                    ((TextView) findViewById(R.id.pokeNameTV)).setText(jsonObject.getString("name"));
                    ((TextView) findViewById(R.id.numberField)).setText(String.valueOf(jsonObject.getInt("id")));
